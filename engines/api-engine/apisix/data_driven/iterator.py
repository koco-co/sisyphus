...
from apisix.core.models import TestCase, TestStep
from apisix.data_driven.data_source import DataSourceFactory, DataSourceReader
...
class DataDrivenIterator:
    ...
    def _create_augmented_test_case(
        ...
        if augmented_test_case.config is None:
            from apisix.core.models import GlobalConfig
